    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <form wire:submit.prevent="save">
            ...
            <div class="flex items-center justify-start space-x-4">
                ...
                <button type="submit"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5">
                    Save
                </button>
            </div>
