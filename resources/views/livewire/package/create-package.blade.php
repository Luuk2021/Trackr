    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <form wire:submit.prevent="save">
            ...
            <div class="mb-6">
                ...
                <input dusk="email" type="email" wire:model="package.email" placeholder="{{ __('Enter email') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="firstname" type="text" wire:model="package.firstname" placeholder="{{ __('Enter first name') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="lastname" type="text" wire:model="package.lastname" placeholder="{{ __('Enter last name') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="streetname" type="text" wire:model="package.streetname" placeholder="{{ __('Enter street name') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="housenumber" type="text" wire:model="package.housenumber" placeholder="{{ __('Enter house number') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="zipcode" type="text" wire:model="package.zipcode" placeholder="{{ __('Enter zip code') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="city" type="text" wire:model="package.city" placeholder="{{ __('Enter city') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
