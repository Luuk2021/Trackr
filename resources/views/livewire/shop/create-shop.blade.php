    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <form wire:submit.prevent="save">
            ...
            <div class="mb-6">
                ...
                <input dusk="streetname" type="text" wire:model="shop.streetname" placeholder="{{ __('Enter street name') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="housenumber" type="text" wire:model="shop.housenumber" placeholder="{{ __('Enter house number') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="zipcode" type="text" wire:model="shop.zipcode" placeholder="{{ __('Enter zip code') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
            ...
            <div class="mb-6">
                ...
                <input dusk="city" type="text" wire:model="shop.city" placeholder="{{ __('Enter city') }}..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
