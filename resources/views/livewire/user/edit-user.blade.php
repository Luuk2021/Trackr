    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <form wire:submit.prevent="save">
            ...
            <div class="mb-6">
                ...
                <input dusk="name" type="text" wire:model="users.name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Change name..." required="">
